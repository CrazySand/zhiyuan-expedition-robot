...
```powershell
ssh -J agi@192.168.1.115 -L 59301:192.168.100.110:59301 -L 53176:192.168.100.110:53176 -L 50807:192.168.100.110:50807 -L 56322:192.168.100.100:56322 -L 56666:192.168.100.110:56666 -L 59888:192.168.100.110:59888 -R 8001:localhost:8000 -N agi@192.168.100.110
```
...
**使用说明：**
- 执行后保持终端不关闭，端口转发才有效
- 本机可通过 `localhost:59301`、`50807`、`56322`、`56666`、`59888` 访问对应服务
