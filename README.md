...
```powershell
ssh -J agi@192.168.1.115,agi@192.168.100.100 -L 59301:192.168.100.110:59301 -L 50807:192.168.100.110:50807 -L 56322:192.168.100.110:56322 -L 56666:192.168.100.110:56666 -L 59888:192.168.100.110:59888 -R 8001:localhost:8000 -N agi@192.168.100.110
```
...
**本地端口转发（-L）** - 从本地访问远程服务：
- `-L 59301:192.168.100.110:59301`: 本地访问 `localhost:59301` → 转发到远程 `192.168.100.110:59301`（TTS/Agent 服务）
- `-L 56666:192.168.100.110:56666`: 本地访问 `localhost:56666` → 转发到远程 `192.168.100.110:56666`（音频服务）
- `-L 59888:192.168.100.110:59888`: 本地访问 `localhost:59888` → 转发到远程 `192.168.100.110:59888`（其他服务）
...
- 本地可以通过 `localhost:59301`、`localhost:56666`、`localhost:59888` 访问远程服务
- 远程机器人可以通过 `192.168.100.110:8001` 访问本地 PC 端的 API 服务（例如 FaceID 回调）
